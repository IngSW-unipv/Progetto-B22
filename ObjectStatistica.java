...
/**
 * Classe ObjectStatistica implementa il metodo
 * @see numerodati
 * dell'interfaccia Istatistica
 */

public class ObjectStatistica implements Istatistica {

	/**
	 * numerodati accetta come parametro
	 * @param username di tipo stringa del dentista di interessse
	 */
